...
⚠️ 중요 규칙:
1. 먼저 나에게 질문을 5~8개 해줘 (STEP 1-0: 대화 탐색)
2. 내 대답을 듣고, 아이디어를 3~5개 러프하게 제안해줘 (STEP 1-A)
3. 내가 고르면 그때부터 구체화해 (STEP 1-B~1-E)
4. 각 단계마다 승인을 받아야 다음으로 넘어가
5. 처음부터 완성된 기획을 내놓지 마

영상에 대해 말해줄게: [여기에 대략적 주제/아이디어 입력]
```
...
사용자: "고양이 캐릭터 영상 만들고 싶어" (대략적 주제)
  ↓
AI: 💬 질문 5~8개 (스타일, 분위기, 캐릭터, 스토리, 용도 등)
사용자: 질문에 대답
  ↓
AI: 💬 추가 질문 (필요시)
사용자: 대답
